    ...
    nTotalWeight(0)
{
    ...
    QString windowTitle = tr("Reddcoin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(bool fIsTestnet)
{
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Reddcoin-Qt help message to get a list with possible Reddcoin command-line options"));
