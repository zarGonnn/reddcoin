...
int main(int argc, char *argv[])
{
    ...
    if (!boost::filesystem::is_directory(GetDataDir(false)))
    {
        ...
        QMessageBox::critical(0, "Reddcoin",
    ...
    QApplication::setOrganizationName("Reddcoin");
    QApplication::setOrganizationDomain("reddcoin.com");
    if (GetBoolArg("-testnet", false)) // Separate UI settings for testnet
        QApplication::setApplicationName("Reddcoin-Qt-testnet");
    else
        QApplication::setApplicationName("Reddcoin-Qt");
